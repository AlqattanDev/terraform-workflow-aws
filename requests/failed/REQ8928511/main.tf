...
# Generated for ticket: REQ8928511
# Requested by: ali.alqattan@bank-abc.com
# Created: 2025-12-04T02:14:27Z
...
terraform {
  ...
  backend "s3" {
    ...
    key            = "requests/REQ8928511/terraform.tfstate"
    region         = "us-east-1"
...
resource "aws_instance" "main" {
  ...
  user_data = <<-EOF
    #!/bin/bash
    yum update -y
    echo "Instance provisioned for ticket REQ8928511" > /var/log/provision.log
  EOF
