# S3 Bucket Template
# Generated for ticket: REQ0000003
# Requested by: ali@example.com
# Created: 2025-12-04T01:56:24Z
...
terraform {
  ...
  backend "s3" {
    ...
    key            = "requests/REQ0000003/terraform.tfstate"
    region         = "us-east-1"
...
resource "aws_s3_bucket" "main" {
  bucket = "test-final-success-414483036967"

  tags = {
    Name = "test-final-success-414483036967"
  }
}
