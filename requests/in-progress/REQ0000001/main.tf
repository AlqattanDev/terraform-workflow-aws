# S3 Bucket Template
# Generated for ticket: REQ0000001
# Requested by: ali@example.com
# Created: 2025-12-04T01:43:15Z
...
terraform {
  ...
  backend "s3" {
    ...
    key            = "requests/REQ0000001/terraform.tfstate"
    region         = "us-east-1"
...
resource "aws_s3_bucket" "main" {
  bucket = "test-bucket-from-workflow-414483036967"

  tags = {
    Name = "test-bucket-from-workflow-414483036967"
  }
}
